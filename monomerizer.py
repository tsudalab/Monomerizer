...
def parse_arguments():
    ...
    parser.add_argument("--output_dir", default="data/smi2fasta_output", help="Output directory")
...
def load_data(input_fn):
    ...
    df = pd.read_csv(input_fn, sep='\t', on_bad_lines='warn')
...
def label_molecules_in_batches(mol_df, batch_size, smi2mol, ignore_cyclic_peptide, min_amino_acids, max_workers=max_workers):
